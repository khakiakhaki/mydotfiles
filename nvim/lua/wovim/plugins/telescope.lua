...
local cfg = require("wovim.keybindings").telescope
...
if telescope and lga_actions and cfg and cfg.enable then
  ...
  keymap("n", cfg.keys.oldfiles, "<CMD>Telescope live_grep<CR>")
  keymap("n", cfg.keys.live_grep, ":Telescope oldfiles<CR>")
  keymap("n", cfg.keys.command_history, ":<CMD>Telescope command_history<CR>")
