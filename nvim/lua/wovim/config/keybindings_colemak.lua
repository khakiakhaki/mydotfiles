...
map("n", "s.", ":vertical resize +10<CR>", opt)
-- 上下比例
map("n", "sn", ":resize +10<CR>", opt)
map("n", "se", ":resize -10<CR>", opt)
...
-- Terminal相关
map("n", "st", ":vsp | terminal<CR>", opt)
map("n", "sth", ":sp | terminal<CR>", opt)
-- Esc 回 Normal 模式
map("t", "<Esc>", "<C-\\><C-n>", opt)
-- map("t", "<A-h>", [[ <C-\><C-N><C-w>h ]], opt)
-- map("t", "<A-n>", [[ <C-\><C-N><C-w>j ]], opt)
-- map("t", "<A-e>", [[ <C-\><C-N><C-w>k ]], opt)
-- map("t", "<A-i>", [[ <C-\><C-N><C-w>l ]], opt)
